-- =====================================================================
-- Gold Layer: bridge_customer_source_of_income
...
-- Grant permissions
GRANT SELECT ON gold.bridge_customer_source_of_income TO dw_etl_service;
GRANT INSERT ON gold.bridge_customer_source_of_income TO dw_etl_service;
GRANT DELETE ON gold.bridge_customer_source_of_income TO dw_etl_service;
GRANT SELECT ON gold.bridge_customer_source_of_income TO dw_privileged;
GRANT SELECT ON gold.bridge_customer_source_of_income TO dw_analyst;